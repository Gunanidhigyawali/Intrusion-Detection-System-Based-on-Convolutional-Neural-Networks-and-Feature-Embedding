...
def load_pairs(pairs_file):
    ...
    with open(pairs_file, 'r') as f:
        for line in f:
            ...
            label = int(parts[0])   # ✅ FIRST column
            path1 = parts[1]
            path2 = parts[2]
...
def compute_embeddings(pairs):
    ...
    return embedding_cache, avg_time, total_time
...
if __name__ == "__main__":
    ...
    # Compute embeddings once (FAST)
    print("\nComputing embeddings...")
    embeddings, avg_time, total_time = compute_embeddings(pairs)
